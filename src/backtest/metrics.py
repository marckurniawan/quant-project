...
def calculate_expectancy(signals: pd.Series) -> float:
    """Calculate the expected return per trade."""
...
def calculate_sharpe_ratio(returns: pd.Series, trades_per_year: float) -> float:
    """Calculate the annualized Sharpe ratio from trade returns."""
